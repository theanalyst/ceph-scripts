...
then
  ...
  echo "echo \"cephrepairs.test.${cluster}.drain.${AWKHOST}.${OSD} 0 `date +%s`\" | nc filer-carbon.cern.ch 2003"
  echo "echo \"cephrepairs.test.${cluster}.prepare.${AWKHOST}.${OSD} 1 `date +%s`\" | nc filer-carbon.cern.ch 2003"
else
